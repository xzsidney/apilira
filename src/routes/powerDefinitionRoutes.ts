...
} from "../controllers/powerDefinitionController";
 ...
 */
router.get("/", getPowerDefinitions);
 ...
 */
router.post("/", createPowerDefinition);
 ...
 */
router.put("/:id", updatePowerDefinition);
 ...
 */
router.delete("/:id", deletePowerDefinition);
