...
const vampireCreationSchema = z.object({
  ...
  vampireResonanceId: z.string().optional().nullable(),
  vampireGeneration: z.number().int().min(3).max(16).optional().nullable(),
  vampireSire: z.string().max(255).optional().nullable(),
  vampireHunger: z.number().int().min(0).max(5).optional().nullable(),
  vampireAmbition: z.string().max(255).optional().nullable(),
  vampireDesire: z.string().max(255).optional().nullable(),
