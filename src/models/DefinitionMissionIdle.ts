...
export interface DefinitionMissionIdleCreationAttributes extends Optional<DefinitionMissionIdleAttributes, 'id' | 'userId' | 'locationId' | 'allowedRequirements' | 'rewardsJson' | 'penaltiesJson' | 'maxCompletions'> {}
