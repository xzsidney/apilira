...
exports.updateDefinitionAttributeSchema = exports.createDefinitionAttributeSchema = void 0;
const zod_1 = require("zod");
exports.createDefinitionAttributeSchema = zod_1.z.object({
    body: zod_1.z.object({
        name: zod_1.z.string().min(1, 'Nome é obrigatório'),
        description: zod_1.z.string().min(1, 'Descrição é obrigatória'),
        type: zod_1.z.enum(['FISICO', 'SOCIAL', 'MENTAL'], {
...
exports.updateDefinitionAttributeSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        type: zod_1.z.enum(['FISICO', 'SOCIAL', 'MENTAL']).optional(),
