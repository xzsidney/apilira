...
exports.discoverLocation = exports.exploreLocation = exports.getRadarLocations = void 0;
        ...
        if (characterId) {
            ...
            if (knownRecords.length === 0 && allDistricts.length > 0) {
                ...
                if (initialDiscoveries.length > 0) {
                    await index_1.CharacterKnownLocation.bulkCreate(initialDiscoveries);
                    knownRecords = await index_1.CharacterKnownLocation.findAll({
                        where: { characterId: String(characterId) }
                    });
                }
            }
            ...
            for (const zone of zones) {
                ...
                for (const child of rawChildren) {
                    ...
                    const locationMissions = allMissions.filter(m => m.locationId === child.id || !m.locationId);
                    visibleChildren.push({
                        ...child,
